...
public class EmailService {
    ...
    public void sendFraudAlert(String to, String transactionId, double amount, String riskLevel) {
        ...
        try {
            ...
            System.err.println("⚠️ NETWORK FALLBACK: Could not dispatch email due to error: " + e.getMessage());
            System.out.println("----------------------------------------------");
    ...
    public void sendWelcomeEmail(String toEmail, String username, String role, String password) {
        ...
        try {
            ...
            String htmlBody = String.format(
                ...
                "      <li style=\"margin-bottom: 8px;\">Log in to the <a href=\"https://secure-pay-frontend.onrender.com\" style=\"color: #2563eb; text-decoration: none; font-weight: 600;\">SecurePay Operations Portal</a>.</li>" +
            ...
            System.err.println("⚠️ NETWORK FALLBACK: Manual onboarding record generated for: " + username + " | Error: " + e.getMessage());
            System.out.println("----------------------------------------------");
